...
class ANNTFLiteService {
  ...
  // Model configuration
  static const int inputSize = 28; // ANN Input size
  static const int numChannels = 3; // RGB
  static const int numClasses = 36; 

  // Load model and labels
  Future<void> loadModel() async {
    print('📦 Connecting to ANN backend...');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _isModelLoaded = data['ann_loaded'] ?? false;
        print('✅ ANN Backend connected!');
      } else {
  ...
  Future<Map<String, dynamic>> predict(XFile imageFile) async {
    ...
    try {
      ...
      var request = http.MultipartRequest('POST', Uri.parse('$backendUrl/ann/predict'));
