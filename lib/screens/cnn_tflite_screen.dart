...
import '../services/cnn_tflite_service.dart';

class CNNTFLiteScreen extends StatefulWidget {
  const CNNTFLiteScreen({super.key});

  @override
  State<CNNTFLiteScreen> createState() => _CNNTFLiteScreenState();
}

class _CNNTFLiteScreenState extends State<CNNTFLiteScreen> {
  final CNNTFLiteService _modelService = CNNTFLiteService();
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('✅ Modèle chargé avec succès'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        iconTheme: const IconThemeData(color: Color(0xFF5CFBAC)),
      ),
      body: SafeArea(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: _modelLoaded ? const Color(0xFF5CFBAC) : const Color(0xFF2E2E2E),
                    width: 1,
                  ),
                ),
                child: Row(
                  children: [
                    Icon(
                      ...
                      color: _modelLoaded ? const Color(0xFF5CFBAC) : const Color(0xFF9E9E9E),
                    ),
                    const SizedBox(width: 12),
                    Text(
                      _modelLoaded ? 'Modèle chargé (Offline)' : 'Chargement...',
              ...
              if (_prediction != null && _prediction!['success'] == true) ...[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: const Color(0xFF5CFBAC), width: 1),
                  ),
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(
                          color: Color(0xFF5CFBAC), fontSize: 18, fontWeight: FontWeight.w500),
                      ),
                      const SizedBox(height: 16),
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFF5CFBAC)),
                        ),
                      ),
                    ],
                  ),
